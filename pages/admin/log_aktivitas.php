...
// Contoh data log aktivitas — nanti kamu ganti dengan query dari database
$log_aktivitas = [
    ['waktu' => '2025-05-21 08:30:00', 'user' => 'admin', 'aksi' => 'Login ke sistem'],
    ['waktu' => '2025-05-21 09:15:10', 'user' => 'admin', 'aksi' => 'Menambah data tamu: Budi'],
    ['waktu' => '2025-05-21 10:00:45', 'user' => 'resepsionis', 'aksi' => 'Update status kunjungan: Tamu selesai'],
    ['waktu' => '2025-05-21 11:20:30', 'user' => 'admin', 'aksi' => 'Logout dari sistem'],
];
?>
      ...
      <table class="table table-bordered table-striped align-middle">
        ...
        <tbody>
          ...
          <?php if (empty($log_aktivitas)): ?>
            <tr>
              <td colspan="3" class="text-center">Tidak ada data log aktivitas.</td>
            </tr>
          <?php endif; ?>
        </tbody>
      </table>
